  ...
  return (
    <div className='mt-8 md:mt-14'>
      ...
      <div className='hidden w-screen lg:block'>
        ...
        <div className='mt-6 flex items-center justify-between  bg-[#cbd1f4] p-20'>
          <div className='relative h-[411px] w-[49%]'>
            <Image
          ...
          <div className='h-full w-[49%]'>
            ...
            >
              <p className=' font-black leading-[60px] text-ace-black lg:text-[36px] xl:text-[48px] '>
