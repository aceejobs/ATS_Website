    ...
    <div>
      ...
      <div className="container mx-auto mt-8">
        <div className="grid md:grid-cols-2">
          <div>
          <h2 className="text-2xl font-semibold mt-8">{job.title}</h2>
            <p className="text-gray-600">{job.company}</p>
            <p className="text-gray-600">{job.location}</p>
            <p className='text-xl font-bold mb-1 mt-4'>Description</p>
      ...
      <div className="container mx-auto mt-8">
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <div className="my-8">
            <button
              type="submit"
              className="bg-ace-blue text-white py-2 px-4 rounded-lg hover:bg-blue-700"
            >
              Apply Now
            </button>
          </div>
